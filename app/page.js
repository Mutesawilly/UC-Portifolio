...
export default function Home() {
  return (
    <main className="font-serif min-h-screen">
      ...
      <div className="flex flex-wrap items-center justify-center p-10 gap-5">
        <div className="bg-pink-100 p-5 w-[68%]">
          <p>Helping users track their mental well-being through quick daily check-ins, built to feel warm, intuitive, and stigma-free.</p>
        </div>
        <div className="bg-pink-50 w-[30%] p-5">
          <p>A dashboard that unifies orders, sales, and returns across Amazon, Flipkart, and Myntra in one place.</p>
        </div>
      </div> */}
        ...
        <div className="bg-pink-100 w-dvw flex justify-center p-10 rounded-lg">
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center justify-center pb-10">
              <p className="text-3xl">If not <span className="text-pink-600 cursor-pointer">me, who?</span> If not <span className="text-green-600 cursor-pointer">now, when?</span></p>
            </div>
